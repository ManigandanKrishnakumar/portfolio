  ...
  SECURITY: [
    {
      ...
      TECH_STACK: 'Burpsuite, Dirbuster, Javascript',
      DESC: 'Performed vulnerability assessement on a banking application and found serveral vulnerabilities. Reported the findings with information about severity, evidence, steps to reproduce and remediation',
      CATAGORY: PROJECT_CATAGORY.MOBILE,
      IMAGES: [],
    },
    {
